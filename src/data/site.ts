...
export const site = {
  ...
  tagline: 'Thoughtful, elegant gardens designed for modern life',
  description:
  ...
  services: [
    {
      ...
      points: ['A visit to your garden to look at the space, light and soil', 'A conversation about how you want to use the space', 'Practical advice on layout, planting and materials'],
    },
    {
      id: 'planting-design',
      ...
      points: ['Plant selection matched to your soil and aspect', 'Layered, seasonal interest with a clear structure', 'A planting plan which you or your landscapers can follow'],
    },
    {
